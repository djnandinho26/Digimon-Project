        ...
        public static void Load(string fileName)
        {
                    ...
                    for (int g = 0; g < List; g++)
                    {
                        ...
                        for (int a = 0; a < Categories; a++)
                        {
                            ...
                            for (int r = 0; r < Items; r++)
                            {
                                ...
                                ItemMaking.Add(item);
                                /*using (System.IO.StreamWriter file =
                    new System.IO.StreamWriter(@"logs\ItemMaking.txt", true))
                                {
                                    file.WriteLine("NPCiD= {0} | List= {1} |  ID= {2} |  ID2= {3} |  ID3= {4}", NPCiD, List, ID, ID2, ID3);
                                }*/
                            }
                        }
            ...
            using (BitReader read = new BitReader(File.OpenRead(fileName)))
            {
                ...
                for (int s = 0; s < cShop; s++)
                {
                    ...
                    using (System.IO.StreamWriter file =
                        new System.IO.StreamWriter(@"logs\ShopItem.txt", true))
                    {
                        file.WriteLine("shop.ID= {0} | shop.NPC= {1} |  shop.ItemID= {2} |  shop.Items= {3} |  shop.Amount= {4} |  shop.ItemCount= {5}", shop.ID, shop.NPC, shop.ItemID, shop.Items, shop.Amount, shop.ItemCount);
                    }
                }*/
                ...
                for (int i = 0; i < XAICount; i++)
                {
                    ...
                    /*using (System.IO.StreamWriter file =
                        new System.IO.StreamWriter(@"logs\XAI.txt", true))
                    {
                        file.WriteLine("xai.ItemID= {0} | xai.XGauge= {1} |  xai.Unknown= {2}", xai.ItemID, xai.XGauge, xai.Unknown);
                    }*/
                }
